...
for data in datareader:
    ...
    #Start of tag_category and source_generated combination
    ...
    #End of tag_category and source_generated combination

    #Start of tag_category and city combination
    if data[10]+city in cat_votes:
        cat_votes[data[10]+city].append(votes)
    else:
        cat_votes[data[10]+city] = [votes]

    if data[10]+city in cat_comments:
        cat_comments[data[10]+city].append(comments)
    else:
        cat_comments[data[10]+city] = [comments]

    if data[10]+city in cat_views:
        cat_views[data[10]+city].append(views)
    else:
        cat_views[data[10]+city] = [views]
    #End of city and tag_category combination

    #Start of tag_category and city combination and source_generated combination
    if data[10]+city+data[8] in cat_votes:
        cat_votes[data[10]+city+data[8]].append(votes)
    else:
        cat_votes[data[10]+city+data[8]] = [votes]

    if data[10]+city+data[8] in cat_comments:
        cat_comments[data[10]+city+data[8]].append(comments)
    else:
        cat_comments[data[10]+city+data[8]] = [comments]

    if data[10]+city+data[8] in cat_views:
        cat_views[data[10]+city+data[8]].append(views)
    else:
        cat_views[data[10]+city+data[8]] = [views]
    #End of tag_category and city combination and source_generated combination
...
print cat_votes_median
print cat_comments_median
print cat_views_median
...
for data in datareader:
    ...
    tag_category = data[7]
    source_generated = data[5]

    if  tag_category+city+source_generated in cat_views_median:
        data_views = round(cat_views_median[tag_category+city+source_generated],1)
        data_votes = round(cat_votes_median[tag_category+city+source_generated],1)
        data_comments = round(cat_comments_median[tag_category+city+source_generated],1)
    elif tag_category+source_generated in cat_views_median:
        data_views = round(cat_views_median[tag_category+source_generated],1)
        data_votes = round(cat_votes_median[tag_category+source_generated],1)
        data_comments = round(cat_comments_median[tag_category+source_generated],1)
    elif tag_category+city in cat_views_median:
        data_views = round(cat_views_median[tag_category+city],1)
        data_votes = round(cat_votes_median[tag_category+city],1)
        data_comments = round(cat_comments_median[tag_category+city],1)
    elif source_generated in cat_views_median:
        data_views = round(cat_views_median[source_generated],1)
        data_votes = round(cat_votes_median[source_generated],1)
        data_comments = round(cat_comments_median[source_generated],1)
    elif city in cat_views_median:
        data_views = round(cat_views_median[city],1)
        data_votes = round(cat_votes_median[city],1)
        data_comments = round(cat_comments_median[city],1)
    elif tag_category in cat_views_median:
        data_views = round(cat_views_median[tag_category],1)
        data_votes = round(cat_votes_median[tag_category],1)
        data_comments = round(cat_comments_median[tag_category],1)
